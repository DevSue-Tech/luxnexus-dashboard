		...
		<footer className='bg-black'>
			<div className='mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8'>
				<div className='md:flex md:justify-between'>
					<div className='mb-6  w-[400px] md:mb-0'>
						<a href='https://flowbite.com/' className='flex items-center'>
						
							<span className=' font-serrat self-center text-2xl font-semibold whitespace-nowrap text-main'>
								Luxenexus
							</span>
						</a>
						<h2 className=' mt-5 text-white'>
					The premier e-commerce destination where style meets luxury, renowned
					for providing its customers with specially curated high-fashion and
